...
bool Adafruit_HUSB238::getCCdirection() {
  Adafruit_BusIO_Register ccRegister = Adafruit_BusIO_Register(i2c_dev, HUSB238_PD_STATUS1);
  Adafruit_BusIO_RegisterBits ccBit = Adafruit_BusIO_RegisterBits(&ccRegister, 1, 7);  // 7th bit
  return ccBit.read();
}
...
bool Adafruit_HUSB238::isAttached() {
  Adafruit_BusIO_Register attachRegister = Adafruit_BusIO_Register(i2c_dev, HUSB238_PD_STATUS1);
  Adafruit_BusIO_RegisterBits attachBit = Adafruit_BusIO_RegisterBits(&attachRegister, 1, 6);  // 6th bit
...
HUSB238_ResponseCodes Adafruit_HUSB238::getPDResponse() {
  Adafruit_BusIO_Register pdRegister = Adafruit_BusIO_Register(i2c_dev, HUSB238_PD_STATUS1);
  Adafruit_BusIO_RegisterBits pdBits = Adafruit_BusIO_RegisterBits(&pdRegister, 3, 3);  // Bits 3-5
...
bool Adafruit_HUSB238::get5VContractV() {
  Adafruit_BusIO_Register pdRegister = Adafruit_BusIO_Register(i2c_dev, HUSB238_PD_STATUS1);
  Adafruit_BusIO_RegisterBits contractVBit = Adafruit_BusIO_RegisterBits(&pdRegister, 1, 2);  // 2nd bit
...
HUSB238_5VCurrentContract Adafruit_HUSB238::get5VContractA() {
  Adafruit_BusIO_Register pdRegister = Adafruit_BusIO_Register(i2c_dev, HUSB238_PD_STATUS1);
  Adafruit_BusIO_RegisterBits contractABits = Adafruit_BusIO_RegisterBits(&pdRegister, 2, 0);  // Bottom two bits (0-1)
...
HUSB238_VoltageSetting Adafruit_HUSB238::getPDSrcVoltage() {
  Adafruit_BusIO_Register pd0Register = Adafruit_BusIO_Register(i2c_dev, HUSB238_PD_STATUS0);
  Adafruit_BusIO_RegisterBits srcVoltageBits = Adafruit_BusIO_RegisterBits(&pd0Register, 4, 4);  // Bits 4-7
...
HUSB238_CurrentSetting Adafruit_HUSB238::getPDSrcCurrent() {
  Adafruit_BusIO_Register pd0Register = Adafruit_BusIO_Register(i2c_dev, HUSB238_PD_STATUS0);
  Adafruit_BusIO_RegisterBits srcCurrentBits = Adafruit_BusIO_RegisterBits(&pd0Register, 4, 0);  // Bits 0-3
...
bool Adafruit_HUSB238::isVoltageDetected(HUSB238_PDSelection pd) {
  ...
  Adafruit_BusIO_Register pdoRegister = Adafruit_BusIO_Register(i2c_dev, registerAddress);
  
  // Create an Adafruit_BusIO_RegisterBits object for the 7th bit
  Adafruit_BusIO_RegisterBits pdoBit = Adafruit_BusIO_RegisterBits(&pdoRegister, 1, 7);  // 7th bit
...
/*!
    ...
    @details This function reads the bottom four bits (0-3) of the corresponding register
    based on the PD selection to get the detected current. It returns the current as an
    HUSB238_CurrentSetting enum value.
*/
/**************************************************************************/
HUSB238_CurrentSetting Adafruit_HUSB238::currentDetected(HUSB238_PDSelection pd) {
  ...
  Adafruit_BusIO_RegisterBits currentBits = Adafruit_BusIO_RegisterBits(&pdoRegister, 4, 0);  // Bits 0-3
...
void Adafruit_HUSB238::selectPD(HUSB238_PDSelection pd) {
  ...
  Adafruit_BusIO_Register pdoRegister = Adafruit_BusIO_Register(i2c_dev, HUSB238_SRC_PDO);

  // Create an Adafruit_BusIO_RegisterBits object for bits 4-7 of SRC_PDO
  Adafruit_BusIO_RegisterBits pdoBits = Adafruit_BusIO_RegisterBits(&pdoRegister, 4, 4);  // Bits 4-7
...
/*!
    ...
    @details This function reads bits 4-7 of the SRC_PDO register to get the selected PDO.
    It returns the PDO as an HUSB238_PDSelection enum value.
*/
/**************************************************************************/
...
void Adafruit_HUSB238::reset() {
  ...
  Adafruit_I2CRegister goCommandRegister = Adafruit_BusIO_Register(i2c_dev, HUSB238_GO_COMMAND);

  // Create an Adafruit_I2CRegisterBits object for the bottom 5 bits (0-4) of GO_COMMAND
  Adafruit_I2CRegisterBits resetBits = Adafruit_BusIO_RegisterBits(&goCommandRegister, 5, 0);  // Bits 0-4
...
void Adafruit_HUSB238::requestPD() {
  ...
  Adafruit_I2CRegisterBits requestBits = Adafruit_BusIO_RegisterBits(&goCommandRegister, 1, 0);  // Bits 0-1
...
void Adafruit_HUSB238::getSourceCapabilities() {
  ...
  // Create an Adafruit_I2CRegisterBits object for the bottom 5 bits (0-4) of GO_COMMAND
  Adafruit_I2CRegisterBits capabilitiesBits = Adafruit_BusIO_RegisterBits(&goCommandRegister, 5, 0);  // Bits 0-4
